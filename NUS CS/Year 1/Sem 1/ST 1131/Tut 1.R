...
#Variables are: 
#1. Beetles: Nominal Categorical variable
#2. Number of times the beetles fed on a disease-resistant plant: Discrete quantitative variable
...
#Variables are: 
#1. Healthy males: Nominal categorical variable
#2. Weight of their food intake: Ordinal categorical variable
